                    ...
                    <div class="container">
                        <nav class="navbar navbar-default zero_mp ">
                            ...
                            <div class="navbar-header">
                                ...
                                <a class="navbar-brand custom_navbar-brand" href="#"><img src="<?php echo base_url() ?>assets/img/logo.png" alt=""></a>
                            </div>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="notes">
                                <div class="note blue">
                                    ...
                                    <img src="<?php echo base_url() ?>assets/img/environment.jpg" alt="">
                                </div>
                                <div class="note red">
                                    <div class="img_overlay">
                                        <p>Sun Homes, Dhaka</p>
                                    </div>
                                    <img src="<?php echo base_url() ?>assets/img/portfolio_1.jpg" alt="">
                                </div>
                                <div class="note green">
                                    <div class="img_overlay">
                                        <p>Sun Homes, Dhaka</p>
                                    </div>
                                    <img src="<?php echo base_url() ?>assets/img/cliemate.jpg" alt="">
                                </div>
                                <div class="note yellow">
                                    <div class="img_overlay">
                                        <p>Sun Homes, Dhaka</p>
                                    </div>
                                    <img src="<?php echo base_url() ?>assets/img/photography.jpg" alt="">
                                </div>
                                <div class="note black">
                                    <div class="img_overlay">
                                        <p>Sun Homes, Dhaka</p>
                                    </div>
                                    <img src="<?php echo base_url() ?>assets/img/species.jpg" alt="">
                                </div>
                            </div>
                            <!--End of notes-->
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="counter_item text-center">
                                <div class="sigle_counter_item">
                                    <img src="<?php echo base_url() ?>assets/img/tree.png" alt="">
                        ...
                        <div class="col-md-3">
                            <div class="counter_item text-center">
                                <div class="sigle_counter_item">
                                    <img src="<?php echo base_url() ?>assets/img/hand.png" alt="">
                                    <div class="counter_text">
                        ...
                        <div class="col-md-3">
                            <div class="counter_item text-center">
                                <div class="sigle_counter_item">
                                    <img src="<?php echo base_url() ?>assets/img/tuhnder.png" alt="">
                                    <div class="counter_text">
                        ...
                        <div class="col-md-3">
                            <div class="counter_item text-center">
                                <div class="sigle_counter_item">
                                    <img src="<?php echo base_url() ?>assets/img/cloud.png" alt="">
                                    <div class="counter_text">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-6 zero_mp">
                                <div class="event_item">
                                    <div class="event_img">
                                        <img src="<?php echo base_url() ?>assets/img/tree_cut_1.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 zero_mp">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 zero_mp">
                                <div class="event_item">
                                    <div class="event_img">
                                        <img src="<?php echo base_url() ?>assets/img/tree_cut_2.jpg" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="event_news">
                            <div class="event_single_item fix">
                                <div class="event_news_img floatleft">
                                    <img src="<?php echo base_url() ?>assets/img/tree_cut_3.jpg" alt="">
                                </div>
                        ...
                        <div class="event_news">
                            <div class="event_single_item fix">
                                <div class="event_news_img floatleft">
                                    <img src="<?php echo base_url() ?>assets/img/tree_cut_4.jpg" alt="">
                                </div>
                                <div class="event_news_text">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="blog_news">
                            <div class="single_blog_item">
                                <div class="blog_img">
                                    <img src="<?php echo base_url() ?>assets/img/climate_effect.jpg" alt="">
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="blog_news">
                            <div class="single_blog_item">
                                <div class="blog_img">
                                    <img src="<?php echo base_url() ?>assets/img/air_pollutuon.jpg" alt="">
                                </div>
                                <div class="blog_content">
                    ...
                    <div class="col-md-4">
                        <div class="blog_news">
                            <div class="single_blog_item">
                                <div class="blog_img">
                                    <img src="<?php echo base_url() ?>assets/img/threat_bear.jpg" alt="">
                                </div>
                                <div class="blog_content">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="market_logo">
                                        <a href=""><img src="<?php echo base_url() ?>assets/img/audiojungle.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="market_logo">
                                        <a href=""><img src="<?php echo base_url() ?>assets/img/codecanyon.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="market_logo">
                                        <a href=""><img src="<?php echo base_url() ?>assets/img/graphicriver.png" alt=""></a>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="market_logo">
